...
//  YourWorkout
//
//  Created by Artem Balashow on 06.02.2018.
...
extension UIView {
    ...
    class BlurView {
        ...
        private func applyBlurEffect(style: UIBlurEffectStyle,
            ...
            self.blur?.layer.cornerRadius = 9
            self.blurContentView?.layer.cornerRadius = 9
            self.vibrancyContentView?.layer.cornerRadius = 9
        }
    }
